...
const PythonIcon = () => (
  <div className="flex flex-col items-center gap-2">
    ...
    >
      <path 
        fill="#3776AB"
        d="M64 10c-28 0-26 12-26 12v18h27v5H28s-18-2-18 27 16 28 16 28h15V82s-1-18 17-18h28s16 0 16-16V28S103 10 64 10z"
      />
      <path 
        fill="#FFD43B"
        d="M64 118c28 0 26-12 26-12V88H63v-5h37s18 2 18-27-16-28-16-28H87v18s1 18-17 18H42s-16 0-16 16v22s-1 16 38 16z"
      />
    </svg>
...
const DjangoIcon = () => (
  <div className="flex flex-col items-center gap-2">
    ...
    >
      <path 
        fill="#092E20"
        d="M40 10h22v70c0 20-10 35-35 35-12 0-20-3-27-8l8-18c5 3 10 5 16 5 10 0 16-6 16-18V10z"
      />
    </svg>
          ...
          <div data-aos="drop-bounce" className="relative flex justify-center w-full">
            ...
            <div className="bg-gray-900 w-full max-w-70 rounded-2xl p-3 shadow-[0_20px_40px_rgba(0,0,0,0.4)] relative z-20 transform -rotate-3 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="w-full aspect-3/4 overflow-hidden rounded-xl bg-gray-800 border-2 border-transparent">
                <img 
                  src={stackImage} 
                  alt="Md Huzaifa — Full Stack & Pyton Developer" 
